...
male_xcell <- read.csv("/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_thyroid_male_immuneInfiltration_aging.csv")
female_xcell <- read.csv("/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_thyroid_female_immuneInfiltration_aging.csv")
...
sex = factor(sample_type, levels = c("female", "male"))
