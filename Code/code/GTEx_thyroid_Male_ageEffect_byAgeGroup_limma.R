...
bonobo = bonobo[,which(gender == "MALE")]
GTEx_phenotypes = GTEx_phenotypes[which(gender == "MALE"),]
...
save(fgseaRes, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_ageEffect_male_below50_GSEA.RData")

write.table(tb, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_ageEffect_male_below50.txt")

# save(fgseaRes, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_ageEffect_male_above50_GSEA.RData")
# write.table(tb, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_ageEffect_male_above50.txt")
