...
GTEx_below50 = get(load("/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_ageEffect_below50_GSEA.RData"))
GTEx_above50 = get(load("/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_ageEffect_above50_GSEA.RData"))
...
sig_pathways = c(GTEx_age$pathway[which(GTEx_age$padj <0.05)], GTEx_below50$pathway[which(GTEx_below50$padj <0.05)], GTEx_above50$pathway[which(GTEx_above50$padj <0.05)])
...
pdf(paste("/home/esaha/Aging_thyroid/results/plots/heatmap/GTEx_thyroid_ageEffect_byAgeGroup_heatmap.pdf", sep = ""),h=25,w=16)
