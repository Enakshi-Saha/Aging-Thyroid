...
save(fgseaRes_h, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_diseaseEffect_hashimoto_GSEA.RData")
save(fgseaRes_g, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_diseaseEffect_goiter_GSEA.RData")
save(fgseaRes_a, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_diseaseEffect_adenoma_GSEA.RData")

write.table(tb_h, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_diseaseEffect_hashimoto.txt")
write.table(tb_g, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_diseaseEffect_goiter.txt")
write.table(tb_a, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_diseaseEffect_adenoma.txt")
