...
design = model.matrix(~ age + gender + race + bmi + ischemic_timeH + rna_degrad + batch_effect +
                        smoking_status + disease*age_group)
...
save(fgseaRes_h, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_diseaseEffect_hashimoto_below50_GSEA.RData")
save(fgseaRes_g, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_diseaseEffect_goiter_below50_GSEA.RData")
save(fgseaRes_a, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_diseaseEffect_adenoma_below50_GSEA.RData")

write.table(tb_h, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_diseaseEffect_hashimoto_below50.txt")
write.table(tb_g, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_diseaseEffect_goiter_below50.txt")
write.table(tb_a, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_diseaseEffect_adenoma_below50.txt")

# save(fgseaRes_h, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_diseaseEffect_hashimoto_above50_GSEA.RData")
# save(fgseaRes_g, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_diseaseEffect_goiter_above50_GSEA.RData")
# save(fgseaRes_a, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_diseaseEffect_adenoma_above50_GSEA.RData")

# write.table(tb_h, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_diseaseEffect_hashimoto_above50.txt")
# write.table(tb_g, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_diseaseEffect_goiter_above50.txt")
# write.table(tb_a, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_diseaseEffect_adenoma_above50.txt")
