...
# Save table for sex effect
# tb = topTable(fit,coef="genderFEMALE",number=Inf)

# Save table for age effect
tb = topTable(fit,coef="age:genderFEMALE",number=Inf)
...
# volcanoPlot
gene_name = fdata.GTEx$gene_name[match(rownames(fit$coefficients),gene_id)]
volcanoplot(fit, coef = "genderFEMALE", style = "p-value", highlight = 100, names = gene_name,
            xlab = "Log2 Fold Change", ylab = NULL, pch=16, cex=0.3)
...
# save(fgseaRes, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_Aging_SexDiff_agingSexInteraction_GSEA.RData")
# save(fgseaRes, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_Aging_SexDiff_agingMALE_GSEA.RData")
# save(fgseaRes, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_Aging_SexDiff_agingFEMALE_GSEA.RData")
# save(fgseaRes, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_SexDiff_FEMALE.RData")

# write.table(tb, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_aging.txt")
# write.table(tb, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_aging_male.txt")
# write.table(tb, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_aging_female.txt")
# write.table(tb, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_sexDiff_female.txt")
