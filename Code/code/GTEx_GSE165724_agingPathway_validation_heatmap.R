library(ggplot2)
# Load GSEA tables 
GTEx = get(load("/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_Aging_SexDiff_ageEffect_withoutSexInteraction_GSEA.RData"))
# GTEx = get(load("/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_Aging_SexDiff_agingMALE_GSEA.RData"))
GSE165724 = get(load("/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GSE165724_normalThyroid_Aging_GSEA.RData"))
# GSE165724 = get(load("/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GSE165724_normalThyroid_Aging_GSEA_maleOnlyModel.RData"))
...
pdf("/home/esaha/Aging_thyroid/results/plots/heatmap/GTEx_GSE165724normal_thyroid_aging_validation.pdf",h=25,w=16)
