...
GTEx_below50 = get(load("/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_ageEffect_male_below50_GSEA.RData"))
GTEx_above50 = get(load("/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_ageEffect_male_above50_GSEA.RData"))
...
pdf(paste("/home/esaha/Aging_thyroid/results/plots/heatmap/GTEx_thyroid_ageEffect_male_byAgeGroup_heatmap.pdf", sep = ""),h=25,w=16)
