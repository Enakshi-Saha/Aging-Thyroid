...
#### Design Matrix
design = model.matrix(~ age*age_group + gender + race + bmi + ischemic_timeH + rna_degrad + batch_effect +
                        smoking_status)
...
save(fgseaRes, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_ageEffect_below50_GSEA.RData")

write.table(tb, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_ageEffect_below50.txt")

# save(fgseaRes, file = "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_Thyroid_ageEffect_above50_GSEA.RData")
# write.table(tb, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/limma_GTEx_thyroid_ageEffect_above50.txt")
