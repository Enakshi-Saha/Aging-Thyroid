...
data = get(load(paste("~/Aging_thyroid/data/validation_data/GSE29315/GSE29315.RData", sep = "")))
dataName = "GSE29315_series_matrix.txt.gz"
...
phenotypes <- read.csv("~/Aging_thyroid/data/validation_data/GSE29315/GSE29315_phenotypes.txt", sep="")
...
write.table(expression, "~/Aging_thyroid/data/validation_data/GSE29315/GSE29315_expression.txt",
            row.names = F, col.names = T, sep = '\t', quote = F)
# save motif prior table
write.table(prior_tab, paste("~/Aging_thyroid/data/validation_data/GSE29315/GSE29315_motif.csv", sep = ""), row.names = FALSE, col.names = TRUE, sep = ",", quote = F)
