...
GSE27155_gsea = get(load("~/Aging_thyroid/results/limma_GSEA_xcell_tables/GSE27155/sexAgnosticGSEA/GSE27155_diseaseEffect_Anaplastic Thyroid Carcinoma_GSEA.RData"))

####### GSE33630 disease pathways ##########
GSE33630_gsea = get(load("~/Aging_thyroid/results/limma_GSEA_xcell_tables/GSE33630/sexAgnosticGSEA/GSE33630_diseaseEffect_anaplastic thyroid carcinoma (ATC)_GSEA.RData"))
...
ATC_info = list()
ATC_info[["dataset"]] = "GSE33630"
ATC_info[["validated_pathways"]] = validated_paths

save(ATC_info, file = "/home/esaha/Aging_thyroid/results/disease_specific_validated_pathways_list/ATC_pathways.RData.")
