...
# write.csv(immune_table, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_thyroid_HashimotoExcluded_male_immuneInfiltration_aging.csv", row.names = T, quote = F)
# write.csv(immune_table, "/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_thyroid_HashimotoExcluded_female_immuneInfiltration_aging.csv", row.names = T, quote = F)
