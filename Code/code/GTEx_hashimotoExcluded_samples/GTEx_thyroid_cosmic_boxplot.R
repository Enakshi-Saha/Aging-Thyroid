...
tb_male <- read.csv("/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_hashimotoExcluded_samples/limma_GTEx_aging_male.txt", sep="")
tb_female <- read.csv("/home/esaha/Aging_thyroid/results/limma_GSEA_xcell_tables/GTEx_hashimotoExcluded_samples/limma_GTEx_aging_female.txt", sep="")
