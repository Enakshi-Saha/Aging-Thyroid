...
data = get(load(paste("~/Aging_thyroid/data/validation_data/GSE27155/GSE27155.RData", sep = "")))
dataName = "GSE27155_series_matrix.txt.gz"
...
phenotypes <- read.csv("~/Aging_thyroid/data/validation_data/GSE27155/GSE27155_phenotypes.txt", sep="")
...
# Remove samples with unidentified sex
expression = expression[,-which(is.na(phenotypes$sex))]
prior_tab = prior_tab[-which(is.na(phenotypes$sex)),]
...
write.table(expression, "~/Aging_thyroid/data/validation_data/GSE27155/GSE27155_expression.txt",
            row.names = F, col.names = T, sep = '\t', quote = F)
# save motif prior table
write.table(prior_tab, paste("~/Aging_thyroid/data/validation_data/GSE27155/GSE27155_motif.csv", sep = ""), row.names = FALSE, col.names = TRUE, sep = ",", quote = F)
